...
import com.vodafone.ft.beans.TimeReportingFacade;
...
public class TimeReportingController implements Serializable {
    ...
    @EJB
    private com.vodafone.ft.beans.TimeReportingFacade ejbFacade;
    ...
    public void createTR(){
        if(selected!=null){
            ...
            prepareCreate();
            try {
            FacesContext.getCurrentInstance().getExternalContext().redirect("/FT/app/jv_timereporting/view_tr.xhtml");
