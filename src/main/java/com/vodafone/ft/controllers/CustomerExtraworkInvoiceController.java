...
import com.vodafone.ft.beans.CustomerExtraworkInvoiceFacade;
...
public class CustomerExtraworkInvoiceController implements Serializable {
    ...
    @EJB
    private com.vodafone.ft.beans.CustomerExtraworkInvoiceFacade ejbFacade;
    ...
    public List<CustomerExtraworkInvoice> getSettelmentInvoices(NetSales selectedUserNs) {
        return getFacade().findSettelmentInvoices(selectedUserNs);
    }
