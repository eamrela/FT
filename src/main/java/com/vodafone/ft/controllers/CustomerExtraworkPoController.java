...
import com.vodafone.ft.beans.CustomerExtraworkPoFacade;
...
public class CustomerExtraworkPoController implements Serializable {
    ...
    @EJB
    private com.vodafone.ft.beans.CustomerExtraworkPoFacade ejbFacade;
    ...
    public List<CustomerExtraworkPo> getSettelmentPOs(NetSales selectedUserNs) {
