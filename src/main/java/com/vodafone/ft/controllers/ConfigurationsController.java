...
public class ConfigurationsController implements Serializable {
    ...
    @EJB
    private com.vodafone.ft.beans.ConfigurationsFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setConfigurationsPK(new com.vodafone.ft.entities.ConfigurationsPK());
    }
    ...
    public Configurations getConfigurations(com.vodafone.ft.entities.ConfigurationsPK id) {
    ...
    public static class ConfigurationsControllerConverter implements Converter {
        ...
        com.vodafone.ft.entities.ConfigurationsPK getKey(String value) {
            com.vodafone.ft.entities.ConfigurationsPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new com.vodafone.ft.entities.ConfigurationsPK();
            key.setConfName(values[0]);
            key.setConfEnviroment(values[1]);
            return key;
        }

        String getStringKey(com.vodafone.ft.entities.ConfigurationsPK value) {
