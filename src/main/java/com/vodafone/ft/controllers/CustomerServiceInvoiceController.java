...
import com.vodafone.ft.beans.CustomerServiceInvoiceFacade;
...
public class CustomerServiceInvoiceController implements Serializable {
    ...
    @EJB
    private com.vodafone.ft.beans.CustomerServiceInvoiceFacade ejbFacade;
    ...
    public List<CustomerServiceInvoice> getSettelmentInvoices(NetSales selectedUserNs) {
        return getFacade().findSettelmentsInvoices(selectedUserNs);
    }
