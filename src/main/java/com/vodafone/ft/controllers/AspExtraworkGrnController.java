...
import com.vodafone.ft.beans.AspExtraworkGrnFacade;
...
public class AspExtraworkGrnController implements Serializable {
    ...
    @EJB
    private com.vodafone.ft.beans.AspExtraworkGrnFacade ejbFacade;
    ...
    public List<AspExtraworkGrn> getSettelmentGRNs(CostOfSales selectedUserCos) {
        return getFacade().findSettelementsGRNs(selectedUserCos);
    }
