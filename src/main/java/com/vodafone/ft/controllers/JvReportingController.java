...
public class JvReportingController implements Serializable {
    ...
    @EJB
    private com.vodafone.ft.beans.JvReportingFacade ejbFacade;
    ...
    public void createJV(){
        if(selected!=null){
            ...
            prepareCreate();
            try {
            FacesContext.getCurrentInstance().getExternalContext().redirect("/FT/app/jv_timereporting/view_jv.xhtml");
