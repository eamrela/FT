...
import com.vodafone.ft.beans.CustomerServicePoFacade;
import com.vodafone.ft.entities.CustomerServiceWorkDone;
...
public class CustomerServicePoController implements Serializable {
    ...
    @EJB
    private com.vodafone.ft.beans.CustomerServicePoFacade ejbFacade;
    ...
    public List<CustomerServicePo> getSettelmentPOs(NetSales selectedUserNs) {
        return getFacade().findSettelmentPOs(selectedUserNs);
    }
    ...
    public void createVFPo(){
        if(selected!=null){
            ...
            prepareCreate();
            try {
            FacesContext.getCurrentInstance().getExternalContext().redirect("/FT/app/purchase_orders/view_customer_po.xhtml");
