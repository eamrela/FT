...
import com.vodafone.ft.beans.AspServiceGrnFacade;
...
public class AspServiceGrnController implements Serializable {
    ...
    @EJB
    private com.vodafone.ft.beans.AspServiceGrnFacade ejbFacade;
    ...
    public List<AspServiceGrn> getSettelmentGRNs(CostOfSales selectedUserCos) {
        return getFacade().findSettelmentGRNs(selectedUserCos);
    }
